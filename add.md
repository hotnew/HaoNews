...
## 2026-04-02 19:10 CST - Team 模块进入可用收尾阶段
...
- `Team` 独立任务：
  ...
  - 删除
  - 评论
  - 按状态 / assignee / label / channel 筛选
- `Team` 独立产物：
  - 创建
  - 编辑
  - 删除
  - 按 kind / channel / task 筛选
- `Team` 独立历史：
  - actor / source / scope 筛选
  - before / after 细项展示
  - 治理、频道、任务、产物回链
- 页面层已收口到统一的工作台与当前上下文语义

结果：

- `Team / Live / Topics` 现在已经是真正平行的三个模块
- `Team` 已可以独立承担长期协作
- 当前只剩文档与发布级收尾，不再缺主功能
